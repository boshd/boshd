...
\begin{document}
    ...
    \begin{longtable}{@{}>{\raggedleft}p{0.25\linewidth}
        ...
        \textbf{frameworks/technologies}
            & \textbf{\textbf{React --- NextJS --- iOS --- Serverless --- REST APIs --- Webhooks (verification + tunneling) --- Websockets --- Kuberentes --- CI/CD (Jenkins, Actions, etc.) --- Firebase --- \href{https://github.com/plaid/plaid-go}{Plaid}}} \\ [2em]
        ...
        \textbf{work experience}
            ...
            & \textbf{\textsc{\href{https://www.neurovine.ai/}{Neurovine}} } --- \textit{Software Engineer}  & \textit{Apr 2019 - Feb 2021} \\ [0.25em]
        ...
        \textbf{projects}
            ...
            & - Realtime financial aggregation \& search --- \textit{React \& Go + Plaid} & \textit{present} \\
            & \quad • Developed a full-stack web application using a Go REST API and a React frontend. \\
            & \quad • Integrated with the Plaid API to consume real-time financial data. \\
            & \quad • Created a search engine using Elasticsearch to index and search thru transactions. \\
            & \quad • Implemented a caching layer using Redis to reduce the number of API calls to Plaid. \\
