...
\begin{itemize}
    ...
    \item \textbf{Frameworks/Technologies:} React, NextJS, iOS, Serverless, Kubernetes, CI/CD, Firebase, Plaid, Stripe, REST APIs
    \item \textbf{AI/ML:} TensorFlow, PyTorch, LangChain, LangSmith, OpenAI, Anthropic, LLM Agents, Vector Stores
...
\begin{itemize}
    ...
    \item Led voice intern interviews; hiring primary for senior engineering roles
    \item Delivered core component of a modality-agnostic reasoner; designed long-silence handling
\end{itemize}
...
\begin{itemize}
    \setlength\itemsep{0em}
    \item \textbf{\href{https://joinbrisa.com}{Brisa}:} AI wealth platform. First Place Fintech Product on ProductHunt. 1000+ users/200 active/\$55m total assets tracked. Tech: Go, React, AWS
    ...
    \item \textbf{\href{https://github.com/boshd/advatck}{Adversarial ML Research}:} Analyzed impact of adversarial attacks on CNN's latent space
\end{itemize}
...
\vspace{-0.5em}
\begin{center}
    \textit{Agentic problem-solver with a track record of delivering high-impact, scalable solutions in full-stack engineering and AI}
\end{center}
