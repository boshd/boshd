...
\begin{document}
    ...
    \begin{longtable}{@{}>{\raggedleft}p{0.25\linewidth}
        ...
        \textbf{languages}
            & \textbf{\textsc{Python --- Java --- Swift --- TypeScript --- Go (Elementary proficiency)}} \\ [0.5em]
        \textbf{frameworks and technologies}
            & \textbf{\textbf{iOS --- XCode --- Realm --- NextJS --- React --- Serverless --- GCP --- AWS --- K8s --- Helm --- Docker --- Vault --- CI/CD (GH Actions, Jenkins, Spinnaker) --- TensorFlow --- MySQL --- Redis --- DynamoDB --- Ionic --- Firebase --- Rancher --- Splunk --- Latex}} \\ [0.2em]
        ...
        \textbf{work experience}
            ...
            & - Led \textbf{scrum \& grooming} sessions, pushing multiple features into the development pipeline + \textbf{onboarding} new engineers. \\
            & - Worked w/ a \textbf{hybrid} system architecture (on-prem servers \& \textbf{GCP}) \\ [0.5em]
