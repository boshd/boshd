...
\begin{document}
    ...
    \begin{longtable}{@{}>{\raggedleft}p{0.25\linewidth}
        ...
        \textbf{frameworks/technologies}
            & \textbf{\textbf{React --- NextJS --- iOS --- Serverless --- REST APIs --- Websockets --- Kuberentes --- CI/CD (Jenkins, Actions, etc.) --- Firebase --- \href{https://github.com/plaid/plaid-go}{Plaid}}} \\ [2em]
        ...
        \textbf{projects}
            ...
            & - Realtime financial aggregator tool --- \textit{React \& Go} & \textit{present} \\ [0.5em]
            ...
            & - Realtime group chat w/ built-in event management --- \textit{iOS \& Serverless} \href{https://github.com/boshd/handshake}{$\rightarrow$} & \textit{2020-2022} \\ [0.5em]
            ...
            & - Neural network implementations using --- \textit{Python \& TensorFlow} \href{https://github.com/boshd/neuralnets}{$\rightarrow$} & \textit{Summer 2020} \\ [0.5em]
